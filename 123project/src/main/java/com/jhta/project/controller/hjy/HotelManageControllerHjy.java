...
public class HotelManageControllerHjy {
	 ...
	 */
	@GetMapping("hjy/ok")
	public String hotelAllow(String aid,String aname,Model model) {
//		찐db에 저장하기

		// 숙소테이블
		System.out.println("aid 내용확인 해보기 ==============================");
		System.out.println(aid);
		System.out.println("aname 내용확인 해보기 ==============================");
		System.out.println(aname);
		AccommodationsVo accommodationsVo = accommodations_tempservice.find(Integer.parseInt(aid));
		System.out.println("accommodationsVo 내용확인 해보기 ==============================");
		System.out.println(accommodationsVo);
...
//					// 2. 업로드된 파일정보 DB에 저장하기
	...
	public static void sendMail(AccommodationsVo accommodationsVo, Additional_feeVo additional_feeVoList,
		...
		String subject = "[숙소등록]";
		String fromEmail = "dta4718@gmail.com";
		...
		final String password = "umnsxtxxydzruydp";
		System.out.println("메일이 발송되지 않았을까?????????????????????????????????????????????");
		// 메일에 출력할 텍스트
